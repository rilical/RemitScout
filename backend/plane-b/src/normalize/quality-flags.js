 ...
 * isQualityFlag('') // false
 */
const isQualityFlag = (value) => {
    return typeof value === 'string' && Object.values(exports.qualityFlags).includes(value);
};
 ...
 */
const areValidQualityFlags = (values) => {
    return Array.isArray(values) && values.every(exports.isQualityFlag);
};
exports.areValidQualityFlags = areValidQualityFlags;

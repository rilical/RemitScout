 ...
 */
export declare const qualityFlags: {
    /**
     * Parse Errors
     */
    ...
    readonly bucket_approx: "bucket_approx";
    /** Input amount bucket doesn't match computed bucket */
    readonly amount_bucket_mismatch: "amount_bucket_mismatch";
    /**
    ...
    readonly estimated_delivery: "estimated_delivery";
    /** Send amount is below provider's minimum send amount */
    readonly min_send_violation: "min_send_violation";
    /**
     * Method Issues
     */
    ...
    readonly unsupported_corridor: "unsupported_corridor";
    /** Method profile could not be derived from payin/payout combination */
    readonly invalid_method_profile: "invalid_method_profile";
};
/**
 ...
 * isQualityFlag('') // false
 */
export declare const isQualityFlag: (value: unknown) => value is QualityFlag;
/**
 ...
 */
export declare const areValidQualityFlags: (values: unknown[]) => values is QualityFlag[];

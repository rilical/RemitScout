...
exports.corridors = supported_corridors_1.WESTERNUNION_SUPPORTED_CORRIDORS;
...
exports.payinMethods = ['bank_transfer', 'debit_card', 'credit_card', 'cash'];
exports.payoutMethods = ['cash_pickup', 'bank_deposit', 'mobile_wallet'];

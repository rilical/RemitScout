...
export const httpLimits = {
  rpm: toNumber(process.env.PLANE_B_WESTERNUNION_RPM, 12),
  concurrency: toNumber(process.env.PLANE_B_WESTERNUNION_CONCURRENCY, 2),
  perLocale: true,
  perCorridorRpm: toNumber(process.env.PLANE_B_WESTERNUNION_CORRIDOR_RPM, 4),
}

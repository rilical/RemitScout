...
import {
  SINGX_DESTINATION_COUNTRIES,
  SINGX_SOURCE_COUNTRIES,
  SINGX_SUPPORTED_CORRIDORS,
} from './supported-corridors'
import { payinMethodMap, payoutMethodMap } from './code-map'

export const sourceCountries = SINGX_SOURCE_COUNTRIES
export const destinationCountries = SINGX_DESTINATION_COUNTRIES
...
export const corridors = SINGX_SUPPORTED_CORRIDORS

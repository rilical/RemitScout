...
export const playwrightLimits = {
  rpm: toNumber(process.env.PLANE_B_INSTAREM_PLAYWRIGHT_RPM, 4),
  concurrency: toNumber(process.env.PLANE_B_INSTAREM_PLAYWRIGHT_CONCURRENCY, 1),
  perLocale: true,
  perCorridorRpm: toNumber(process.env.PLANE_B_INSTAREM_PLAYWRIGHT_CORRIDOR_RPM, 2),
}

...
export const httpLimits = {
  rpm: toNumber(process.env.PLANE_B_XOOM_RPM, 6),
  concurrency: toNumber(process.env.PLANE_B_XOOM_CONCURRENCY, 1),
  perLocale: true,
  perCorridorRpm: toNumber(process.env.PLANE_B_XOOM_CORRIDOR_RPM, 2),
}

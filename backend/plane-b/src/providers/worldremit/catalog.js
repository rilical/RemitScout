...
exports.corridors = supported_corridors_1.WORLDREMIT_SUPPORTED_CORRIDORS;
...
exports.payinMethods = ['bank_transfer', 'debit_card', 'credit_card'];
exports.payoutMethods = ['bank_deposit', 'cash_pickup', 'mobile_wallet', 'airtime'];

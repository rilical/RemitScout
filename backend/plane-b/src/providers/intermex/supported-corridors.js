...
exports.INTERMEX_B2B_CORRIDORS = exports.INTERMEX_SUPPORTED_CORRIDORS = exports.INTERMEX_DESTINATION_COUNTRIES = exports.INTERMEX_DESTINATION_OPTIONS = exports.INTERMEX_SOURCE_COUNTRIES = void 0;
exports.INTERMEX_SOURCE_COUNTRIES = [
    'AS',
    'VG',
    'EC',
    'SV',
...
const INTERMEX_SOURCE_OPTIONS = exports.INTERMEX_SOURCE_COUNTRIES.map(country => ({
    country,
    currency: 'USD',
}));
exports.INTERMEX_DESTINATION_OPTIONS = [
...
exports.INTERMEX_DESTINATION_COUNTRIES = Array.from(new Set(exports.INTERMEX_DESTINATION_OPTIONS.map(option => option.country))).sort();
const buildSupportedCorridors = () => {
    const corridorSet = new Set();
    for (const source of INTERMEX_SOURCE_OPTIONS) {
        for (const destination of exports.INTERMEX_DESTINATION_OPTIONS) {
...
exports.INTERMEX_SUPPORTED_CORRIDORS = buildSupportedCorridors();
exports.INTERMEX_B2B_CORRIDORS = exports.INTERMEX_SUPPORTED_CORRIDORS;

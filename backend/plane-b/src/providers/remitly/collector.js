...
exports.runRemitlyCollector = void 0;
...
const logger = (0, logger_1.createLogger)('plane-b.remitly.collector');
/**
...
const upsertCapability = async (pool, corridorId, payload) => {
    const pairs = (0, parse_1.extractRemitlyMethodPairs)(payload);
 ...
 */
const runRemitlyCollector = async (options = {}) => {
    ...
    if (options.corridors?.length) {
        ...
        const allPossibleCorridors = supported_corridors_1.REMITLY_SUPPORTED_CORRIDORS;
    ...
    await (0, base_1.ensureProvider)(pool, providerId, 'Remitly');
    ...
    for (const corridorId of corridors) {
        ...
        for (const amountBucket of buckets) {
            ...
            while (!completed) {
                ...
                try {
                    fetchResult = await (0, fetch_1.fetchRemitlyQuote)(request, { jitterMs, proxyTier });
                ...
                const parsed = (0, parse_1.parseRemitlyPayload)(fetchResult.payload, request);
...
exports.runRemitlyCollector = runRemitlyCollector;

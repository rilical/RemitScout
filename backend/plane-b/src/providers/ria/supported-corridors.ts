...
export const RIA_SOURCE_COUNTRIES = [
  'AR',
  'AU',
  'AT',
  'BE',
...
const RIA_DESTINATION_PAIRS: Array<[string, string]> = [
  ['CO', 'COP'],
  ['DO', 'DOP'],
  ['IN', 'INR'],
  ['MX', 'MXN'],
...
const buildSupportedCorridors = () => {
  ...
  for (const source of RIA_SOURCE_COUNTRIES) {
...
export const RIA_SUPPORTED_CORRIDORS = buildSupportedCorridors()
export const RIA_B2B_CORRIDORS: string[] = [...RIA_SUPPORTED_CORRIDORS]

...
exports.runWellsFargoCollector = void 0;
...
const logger = (0, logger_1.createLogger)('plane-b.wellsfargo.collector');
const upsertCapability = async (pool, corridorId) => {
...
const runWellsFargoCollector = async (options = {}) => {
    ...
    if (options.corridors?.length) {
        ...
        const allPossibleCorridors = supported_corridors_1.WELLSFARGO_SUPPORTED_CORRIDORS;
    ...
    await (0, base_1.ensureProvider)(pool, providerId, 'Wells Fargo');
    ...
    for (const corridorId of corridors) {
        ...
        for (const amountBucket of buckets) {
            ...
            while (!completed) {
                ...
                try {
                    fetchResult = await (0, fetch_1.fetchWellsFargoQuote)(request, { jitterMs, proxyTier });
                ...
                const parsed = (0, parse_1.parseWellsFargoPayload)(fetchResult.payload);
...
exports.runWellsFargoCollector = runWellsFargoCollector;

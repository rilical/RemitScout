...
exports.getReceivingMethodForPayout = exports.getPaymentMethodForPayin = exports.payoutMethodMap = exports.payinMethodMap = exports.currencyMinorUnits = exports.currencyCodeMap = exports.countryCodeMap = void 0;
...
const CANONICAL_PAYIN_TO_KORONA = {
...
const CANONICAL_PAYOUT_TO_KORONA = {
    bank_deposit: 'card',
    cash_pickup: 'cash',
    mobile_wallet: 'card',
    airtime: 'cash',
...
const getPaymentMethodForPayin = (payinMethod) => {
    if (!payinMethod)
        return CANONICAL_PAYIN_TO_KORONA.debit_card;
...
const getReceivingMethodForPayout = (payoutMethod) => {
    if (!payoutMethod)
        return CANONICAL_PAYOUT_TO_KORONA.bank_deposit;
    return CANONICAL_PAYOUT_TO_KORONA[payoutMethod] ?? CANONICAL_PAYOUT_TO_KORONA.bank_deposit;
};
exports.getReceivingMethodForPayout = getReceivingMethodForPayout;

...
exports.corridors = supported_corridors_1.KORONAPAY_SUPPORTED_CORRIDORS;
...
exports.payinMethods = ['debit_card', 'credit_card'];
exports.payoutMethods = ['bank_deposit', 'cash_pickup'];

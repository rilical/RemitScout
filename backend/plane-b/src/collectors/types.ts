 ...
 */
export const isCollectorRequest = (value: unknown): value is CollectorRequest => {
 ...
 */
export const isCollectorResult = (value: unknown): value is CollectorResult => {
  if (!value || typeof value !== 'object') {
    return false
  }

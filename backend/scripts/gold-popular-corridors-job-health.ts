...
import { getMetrics, metricsContentType } from './gold-popular-corridors-job-metrics'
...
export const startHealthServer = async (
  ...
  const logger = options.logger ?? createLogger('script.gold-popular-corridors-health')
...
if (require.main === module) {
  const logger = createLogger('script.gold-popular-corridors-health')

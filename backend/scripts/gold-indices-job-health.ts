...
import { getMetrics, metricsContentType } from './gold-indices-job-metrics'
...
export const startHealthServer = async (
  ...
  const logger = options.logger ?? createLogger('script.gold-indices-health')
...
if (require.main === module) {
  const logger = createLogger('script.gold-indices-health')

/**
 * Western Union Provider Probe Lambda Handler
 */
...
const logger = createLogger('script.westernunion-probe-lambda')
const PROVIDER_ID = 'westernunion'

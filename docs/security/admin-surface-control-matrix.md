...
| `/api/v1/ops/<provider>/health`, `/api/v1/ops/providers/health` | `requireSuperAdmin` | `super_admin` | yes | yes | yes | read-only | provider-health tests + route matrix | indirect via observer summary/provider health checks |
| `/api/v1/ops/b2b-sweep-status`, `/api/v1/ops/indices/health`, `/api/v1/ops/observer/summary` | `requireSuperAdmin` | `super_admin` | yes | yes | yes | read-only | `backend/tests/admin-surface-route-coverage.test.ts` + route matrix | observer summary yes |
| `/api/v1/ops/api-keys/stale`, `/api/v1/ops/providers/explain` | `requireAdmin` | `admin` | yes | yes | yes | read-only | `backend/tests/admin-surface-route-coverage.test.ts` + route matrix | no |
...
| `/api/v1/ops/modules/*`, `/api/v1/ops/agents/*`, `/api/v1/ops/stress/*`, `/api/v1/ops/quality/*`, `/api/v1/ops/gold/corrections` | `requireAdmin` | `admin` | yes | yes | yes | mutations yes on stress overrides | `backend/tests/admin-surface-route-coverage.test.ts` + route matrix | no |
| `/api/v1/ops/services/health` | `requireSuperAdmin` | `super_admin` | yes | yes | yes | read-only | `backend/tests/admin-surface-route-coverage.test.ts` + route matrix | no |

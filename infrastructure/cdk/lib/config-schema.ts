...
const cdkContextShape = {
  ...
  newRelicIngestKeySecretArn: z.string().optional(),
  newRelicIngestKeySecretJsonKey: z.string().optional(),
  ...
  planeAAdminRevocationFailClosed: optionalBool,
  ...
  agentOrchestratorServiceEnabled: optionalBool,
  stressResponderServiceEnabled: optionalBool,
  normalizationServiceEnabled: optionalBool,
  ...
  newRelicAwsMetricStreamEnabled: optionalBool,
  newRelicAwsLogForwardingEnabled: optionalBool,
  ...
  agentFailureQueueMode: queueMode.optional(),
  agentStressQueueMode: queueMode.optional(),
  toolRequestQueueMode: queueMode.optional(),
  normalizationQueueMode: queueMode.optional(),
  ...
  goldIndicesMinProviders: optionalNumber,
  ...
  agentOrchestratorDesiredCount: optionalNumber,
  stressResponderDesiredCount: optionalNumber,
  normalizationWorkerDesiredCount: optionalNumber,

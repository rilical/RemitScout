<template>
  <section :class="['py-12 sm:py-16', bgClass]">
...
const isDarkBg = computed(() => {
  return props.bgClass === 'bg-brand-600'
    || props.bgClass === 'bg-slate-900'
    || props.bgClass?.includes('slate-900')
    || props.bgClass?.includes('brand-600')
    || props.bgClass?.includes('gray-900')
})
</script>

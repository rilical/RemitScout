  ...
  <section class="py-12 sm:py-16 bg-neutral-50">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      <div class="text-center mb-12">
        <h2 class="text-3xl sm:text-4xl font-bold text-neutral-900 mb-3">Read Our Guides</h2>
        <p class="text-lg text-neutral-600">Everything you need to know about international money transfers</p>
      </div>
      ...
      <div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
        ...
        >
          <!-- Image/Icon Header -->
          <div class="relative h-40 bg-gradient-to-br overflow-hidden" :class="guide.gradient">
...
import { GUIDE_CARDS } from '~/utils/constants';

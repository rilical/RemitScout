            ...
            >
              <defs>
                ...
                >
                  <stop
                    offset="0%"
                    style="stop-color:rgba(16, 185, 129, 0.2);stop-opacity:1"
                  />
                  <stop
                    offset="100%"
                    style="stop-color:rgba(16, 185, 129, 0);stop-opacity:1"
                  />
                </linearGradient>
              </defs>
...
const validateRate = () => {
  ...
  const rateValue = Number.parseFloat(targetRate.value.replace(/[^\d.]/g, ''))

  ...
  <section class="py-12 sm:py-16 bg-gradient-to-b from-neutral-50 to-white">
    <div class="container">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-5xl mx-auto">
        <div class="bg-surface rounded-2xl border-2 border-neutral-200 p-6 shadow-sm">
          ...
          <div class="space-y-4">
            <div class="flex justify-between items-center py-3 border-b border-neutral-100">
              <span class="text-body-sm text-neutral-600">Exchange rate</span>
              <span class="font-semibold text-neutral-900">1 USD → PHP {{ data.bank.rate }}</span>
            </div>

            <div class="flex justify-between items-center py-3 border-b border-neutral-100">
              <span class="text-body-sm text-neutral-600">Transfer fee</span>
            ...
            <div class="bg-neutral-50 rounded-xl p-4 mt-4">
              ...
              <div class="text-h2 font-bold text-neutral-900">
                PHP {{ formatNumber(data.bank.recipientGets) }}
              </div>
            </div>

            <div class="flex items-center gap-2 text-body-sm text-neutral-600 pt-2">
              <svg
                class="h-4 w-4"
                fill="none"
                stroke="currentColor"
        ...
        <div class="bg-gradient-to-br from-brand-50 to-white rounded-2xl border-2 border-brand-600 p-6 shadow-lg relative overflow-hidden">
          <div class="absolute top-2 right-2 bg-success-600 text-white text-body-sm font-bold px-3 py-1 rounded-full">
            Best deal
          </div>
          ...
          <div class="space-y-4">
            ...
            <div class="bg-brand-600 rounded-xl p-4 mt-4 text-white">
              <div class="text-body-sm opacity-90 mb-1">
                Recipient gets
              </div>
              <div class="text-h2 font-bold">
                PHP {{ formatNumber(data.specialist.recipientGets) }}
              </div>
              <div class="text-body-sm mt-2 opacity-90">
      ...
      <div class="mt-6 text-center">
        <button
          class="inline-flex items-center gap-2 text-body-sm text-brand-600 hover:text-brand-700 font-medium focus:outline-none focus:ring-2 focus:ring-brand-600 rounded-lg px-3 py-1"
        ...
        <div
          v-if="showTooltip"
          class="mt-3 max-w-2xl mx-auto bg-neutral-100 rounded-lg p-4 text-body-sm text-neutral-700"
        >
          {{ STR.explainer.tooltip }}
        </div>
      </div>

      <p class="mt-8 text-center text-body-sm text-neutral-500 max-w-2xl mx-auto">

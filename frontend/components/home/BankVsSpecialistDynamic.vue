<template>
  <section class="pt-16 sm:pt-20 pb-8 bg-surface">
    <div class="container">
      <!-- Educational header -->
      ...
      >
        ...
        <div class="bg-surface rounded-3xl border-2 border-danger-600 p-8 shadow-xl hover:shadow-2xl transition-shadow">
          ...
          <div class="space-y-4">
            <div class="bg-danger-600/10 rounded-xl p-5 border border-danger-600/30">
            ...
            <div class="bg-danger-600 rounded-2xl p-6 border-2 border-danger-600 text-white">
        ...
        <!-- Best Specialist Box -->
        <div class="bg-surface rounded-3xl border-3 border-success-600 p-8 shadow-2xl relative">
          <div class="flex items-center gap-4 mb-6">
          ...
          <div class="space-y-4">
            <div class="bg-success-600/10 rounded-xl p-5 border border-success-600/30">
              <div class="text-body-sm text-neutral-500 mb-2">
                Exchange Rate
              </div>
              <div class="text-h3 font-bold text-success-600">
  ...
  <section class="w-screen pt-8 pb-20 sm:pb-28 bg-neutral-900 relative left-1/2 right-1/2 -ml-[50vw] -mr-[50vw]">
    <div class="container">
      <!-- Section Header -->

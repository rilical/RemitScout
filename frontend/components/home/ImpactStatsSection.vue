    ...
    >
      ...
      >
        <div
          v-for="item in statItems"
          :key="item.statKey"
          class="rounded-2xl border border-primary-200 bg-surface p-5 shadow-sm min-w-0 flex flex-col justify-center items-center text-center"
        >
          <div class="flex items-center gap-2 text-h3 font-bold text-brand-600 justify-center">
            <component
              :is="item.icon"
              class="w-7 h-7"
            />

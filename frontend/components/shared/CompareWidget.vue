<template>
  <!-- Desktop: Top sticky -->
  <div class="hidden md:block sticky top-16 z-40 bg-brand-600 border-b border-primary-800 shadow-lg">
  ...
  <div class="md:hidden fixed bottom-0 left-0 right-0 z-50 bg-brand-600 border-t border-primary-800 shadow-2xl">

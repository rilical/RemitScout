    ...
    >
      <div class="space-y-6">
        ...
        <div class="flex gap-3">
          ...
          <div>
            <h4 class="font-medium text-white">Quotes can change at checkout</h4>
        ...
        <div class="flex gap-3">
          ...
          <div>
            <h4 class="font-medium text-white">Provenance tags explained</h4>
        ...
        <div v-if="chartSpecificNote" class="flex gap-3">
          ...
          <div>
            <h4 class="font-medium text-white">About this chart</h4>
            <p class="mt-1 text-sm text-neutral-400">{{ chartSpecificNote }}</p>
          </div>
        </div>

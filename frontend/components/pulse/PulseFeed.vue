<template>
  <div>
    <div class="mb-6 flex items-center justify-between">
      ...
      >
        <option value="24h" class="bg-slate-800">Last 24 hours</option>
            ...
            <div class="flex items-start justify-between gap-4">
              <div class="flex-1">
                <div class="flex flex-wrap items-center gap-2 mb-3">
                  ...
                  >
                    <svg v-if="card.impact === 'high'" class="h-3 w-3" fill="currentColor" viewBox="0 0 20 20">
                ...
                <svg viewBox="0 0 100 50" class="h-full w-full">
                  <defs>
                    <linearGradient :id="`gradient-${card.id}`" x1="0%" y1="0%" x2="0%" y2="100%">
                      <stop offset="0%" :style="`stop-color: ${card.gradientStart}; stop-opacity: 0.3`" />
                      <stop offset="100%" :style="`stop-color: ${card.gradientStart}; stop-opacity: 0`" />
                    </linearGradient>
                  </defs>
                  <path

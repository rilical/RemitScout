    ...
    <div class="relative w-full max-w-lg rounded-2xl border border-neutral-700 bg-neutral-800 shadow-2xl">
      ...
      <div class="p-6">
        ...
        <template v-if="mode === 'share'">
          ...
          <!-- Social Share -->
          <div class="mt-6">
            <p class="mb-3 text-sm text-neutral-400">Or share via:</p>
        ...
        <template v-else>
          ...
          <div class="relative">
            ...
            <button
              ...
              @click="copyEmbedCode"
            >
              <svg v-if="!copiedEmbed" class="h-3.5 w-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 16H6a2 2 0 01-2-2V6a2 2 0 012-2h8a2 2 0 012 2v2m-6 12h8a2 2 0 002-2v-8a2 2 0 00-2-2h-8a2 2 0 00-2 2v8a2 2 0 002 2z" />
              </svg>
          ...
          <!-- Preview -->
          <div class="mt-6">
            <p class="mb-2 text-sm text-neutral-400">Preview:</p>

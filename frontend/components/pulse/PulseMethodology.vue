      ...
      <div class="grid gap-6 md:grid-cols-2">
        <div class="rounded-xl bg-white/5 border border-white/5 p-5">
          <div class="flex items-center gap-3 mb-3">
            ...
            <h3 class="font-semibold text-white">Data Sources</h3>
          </div>
        ...
        <div class="rounded-xl bg-white/5 border border-white/5 p-5">
          <div class="flex items-center gap-3 mb-3">
            ...
            <h3 class="font-semibold text-white">Update Frequency</h3>
          </div>
        ...
        <div class="rounded-xl bg-white/5 border border-white/5 p-5">
          <div class="flex items-center gap-3 mb-3">
            ...
            <h3 class="font-semibold text-white">What "Recipient Gets" Includes</h3>
          </div>
          <p class="text-sm text-slate-400 leading-relaxed">
        ...
        <div class="rounded-xl bg-white/5 border border-white/5 p-5">
          <div class="flex items-center gap-3 mb-3">
            ...
            <h3 class="font-semibold text-white">Why Checkout May Differ</h3>
          </div>
          <ul class="space-y-2 text-sm text-slate-400">

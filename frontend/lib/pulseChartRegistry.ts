...
export const pulseChartRegistry: ChartMetadata[] = [
  ...
  },
  {
    ...
    unit: 'percent',
    unitLabel: '%',
    description: 'Confidence score (0-100) used by Gold indices weighting.',
    insightTemplate: 'Confidence is {value}% ({direction} {delta} pp vs 7d avg)',
    lastUpdated: '',
    requiredFilters: ['corridor', 'amount'],
    tooltipCopy: 'Higher confidence indicates better coverage and stability for index computation.',
    sourceNotes: 'Gold export · cdp_daily · $500 bank bucket · updated daily',
    defaultRange: '90d',
    plusRanges: ['365d'],
  },
  {
    id: 'indices-provider-count',
    ...
    unit: 'count',
    unitLabel: '',
    description: 'Provider coverage count used for indices eligibility and suppression.',
    insightTemplate: 'Coverage is {value} providers ({direction} {delta} vs 7d avg)',
    lastUpdated: '',
    requiredFilters: ['corridor', 'amount'],
    tooltipCopy: 'Indices are typically suppressed when coverage drops below the required provider count.',
    sourceNotes: 'Gold export · cdp_daily · $500 bank bucket · updated daily',
    defaultRange: '90d',
    plusRanges: ['365d'],
  },
  {
    id: 'indices-suppression',
    ...
    unit: 'flag',
    unitLabel: '',
    description: 'Whether each index point is suppressed due to coverage/confidence constraints.',
    insightTemplate: 'Suppressed points show where indices are intentionally hidden',
    lastUpdated: '',
    requiredFilters: ['corridor', 'amount'],
    tooltipCopy: 'Suppression means the index point is intentionally withheld due to insufficient coverage or low confidence.',
    sourceNotes: 'Gold export · cdp_daily · $500 bank bucket · updated daily',
    defaultRange: '90d',
    plusRanges: ['365d'],
  },

            ...
            <div class="grid grid-cols-1 gap-8 lg:grid-cols-2">
              ...
              <div class="text-rs-fg">
                ...
                >
                  ...
                  <div
                    v-if="submitError"
                    class="rounded-lg bg-danger-600 border border-danger-600 p-4"
                  >
                    <div class="flex">
                      <svg
              ...
              <div>
                <!-- Internal Links -->
                <div class="rounded-xl border border-neutral-200 bg-gradient-to-br from-neutral-50 to-white p-6 shadow-sm">
                  ...
                  <div class="grid grid-cols-1 gap-3 sm:grid-cols-2">
                    ...
                    >
                      <div class="mb-2 flex items-center gap-3">
                        ...
                        <div class="flex-1">
                          <span class="font-semibold text-neutral-900 group-hover:text-primary-700">Provider Reviews</span>
                          <p class="mt-1 text-body-sm text-neutral-600">Compare trusted money transfer services</p>
                        </div>
                      </div>
                      <svg
                        class="absolute right-4 top-4 h-4 w-4 text-neutral-400 motion-safe:transition-transform group-hover:translate-x-1 group-hover:text-primary-600"
                        fill="none"
                        stroke="currentColor"
                        viewBox="0 0 24 24"
                      >
                    ...
                    >
                      <div class="mb-2 flex items-center gap-3">
                        ...
                        <div class="flex-1">
                          <span class="font-semibold text-neutral-900 group-hover:text-primary-700">Learn Guides</span>
                    ...
                    >
                      <div class="mb-2 flex items-center gap-3">
                        ...
                        <div class="flex-1">
                          <span class="font-semibold text-neutral-900 group-hover:text-primary-700">About Us</span>
                    ...
                    >
                      <div class="mb-2 flex items-center gap-3">
                        ...
                        <div class="flex-1">
                          <span class="font-semibold text-neutral-900 group-hover:text-primary-700">Our Methodology</span>

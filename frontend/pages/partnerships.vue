  ...
  <div class="min-h-screen bg-surface pb-24 md:pb-0">
    ...
    <section class="py-16 lg:py-20 bg-surface">
      <div class="mx-auto max-w-page px-page-x">
        ...
        <div class="relative overflow-hidden rounded-2xl border border-neutral-200 bg-neutral-50 py-12 -mx-page-x">
    ...
    <section class="py-16 lg:py-20 bg-brand-600 relative overflow-hidden">
    ...
    <section class="py-16 lg:py-20 bg-surface">
      <div class="mx-auto max-w-page px-page-x">
        <div class="mx-auto max-w-5xl">
          ...
          <!-- Remit-Score Visual -->
          <div class="bg-brand-50 border-2 border-brand-200 rounded-3xl p-8 lg:p-12 mb-10">
      ...
      <div class="mx-auto max-w-page px-page-x">
        <div class="mx-auto max-w-5xl">
          ...
          <div class="grid gap-6 md:grid-cols-2">
            <div class="rounded-2xl border border-white/20 bg-white/10 p-6">
              <div class="flex items-start gap-3 mb-3">
                <div class="flex h-10 w-10 items-center justify-center rounded-xl bg-white/15 flex-shrink-0">
                  <svg
                    class="w-6 h-6 text-white"
                    fill="none"
                    stroke="currentColor"
          ...
          <div class="mt-10 text-center">
            <NuxtLink
              to="/methodology"
              class="inline-flex items-center gap-2 rounded-xl bg-white px-6 py-3 text-body font-semibold text-brand-600 hover:bg-white/90 motion-safe:transition-colors"
            >
      ...
      <div class="mx-auto max-w-page px-page-x">
        <div class="mx-auto max-w-4xl">
          ...
          <div class="mt-8 text-center">
            <NuxtLink
              to="/faq"
              class="inline-flex items-center justify-center rounded-xl border-2 border-white/30 bg-transparent px-6 py-3 text-body font-semibold text-white hover:bg-white/10 motion-safe:transition-colors focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-neutral-900"
            >
              View all FAQs
            </NuxtLink>
          </div>
    ...
    <section class="py-16 sm:py-20 bg-brand-600">
      <div class="mx-auto max-w-4xl px-page-x text-center">
        ...
        <p class="text-body-lg text-white/80 mb-10 max-w-2xl mx-auto">
          Listing is free. Rankings are earned by data, not dollars. If your pricing is competitive, our users will find you.
        </p>

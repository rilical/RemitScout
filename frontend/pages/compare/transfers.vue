  ...
  const inboundLinks = uniqueSources
    .map(code => {
      ...
      return {
        ...
        to: `/send-money/${code.toLowerCase()}-to-${country.code.toLowerCase()}`,
      }
    })
...
useSeoMeta({
  title: 'Compare Money Transfers - Live Rates & Fees | RemitScout',
  ...
  ogTitle: 'Compare Money Transfers - Live Rates & Fees',

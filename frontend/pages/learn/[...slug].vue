<template>
  <div class="min-h-screen bg-neutral-50">
    <div class="border-b border-neutral-200 bg-surface">
      <div class="container flex items-center justify-between py-4">
        ...
        >
          ...
          <input
            ...
            class="w-40 bg-transparent text-body-sm text-neutral-800 placeholder-neutral-400 focus:outline-none"
          >
          <button
            type="submit"
            class="rounded-full bg-brand-600 px-3 py-1 text-body-sm font-semibold text-white hover:bg-brand-700"
          >
            Go
          </button>
        </form>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div class="lg:col-span-8">
          <div
            ...
            class="mb-4"
          >
            <div class="mb-2 text-body-sm font-semibold uppercase tracking-wide text-brand-600">
              Money Transfer Basics
            </div>
            <div class="text-neutral-600 text-body-sm">
              Last updated {{ article.lastUpdated || '—' }} • {{ article.readTime || '5 min read' }}
            </div>
          </div>

          <article class="rounded-lg bg-surface p-8 shadow-md">
            <header class="mb-8 border-b pb-8">
              <div class="mb-4 flex items-center">
                <Badge variant="secondary">
                  {{ article?.category }}
                </Badge>
                <span class="ml-4 text-neutral-500">{{ article?.readTime }}</span>
              </div>
              ...
              <div class="flex items-center justify-between">
                <div class="flex items-center">
                  <div class="mr-4 h-12 w-12 rounded-full bg-neutral-300" />
                  <div>
                ...
                <div class="flex items-center space-x-4">
                  <button class="flex items-center text-neutral-500 hover:text-neutral-700">
                    <svg
                      class="mr-1 h-5 w-5"
                      fill="currentColor"
                      viewBox="0 0 20 20"
            ...
            <div class="prose prose-lg max-w-none">
              <RichHtml :content="article?.content || ''" />
            </div>
            ...
            <footer class="mt-8 border-t pt-8">
              <div class="mb-6 flex items-center justify-between">
                <div class="flex items-center">
                  <button class="mr-4 flex items-center text-neutral-500 hover:text-neutral-700">
                    <svg
                      class="mr-1 h-5 w-5"
                      fill="currentColor"
                      viewBox="0 0 20 20"
                  ...
                  <span class="text-neutral-500">{{ article?.helpfulCount }} found this helpful</span>
                </div>
              ...
              <div class="rounded-lg bg-neutral-50 p-6">
                ...
                <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                  <NuxtLink
                    ...
                    class="block rounded-lg border p-4 transition-all hover:bg-surface hover:shadow-md"
                  >
                    <h4 class="mb-1 font-medium text-neutral-900">{{ related.title }}</h4>
                    <p class="text-body-sm text-neutral-600">{{ related.excerpt }}</p>
                  </NuxtLink>
                </div>
              </div>
            </footer>
        ...
        <aside class="lg:col-span-4 space-y-6">
          ...
          <div class="rounded-lg bg-neutral-900 border border-neutral-800 p-5 sticky top-4">
            <div class="flex items-center gap-2 mb-4">
              ...
              <h3 class="text-body font-semibold text-white">
            ...
            <div class="space-y-4 text-body-sm">
              ...
              <div class="pt-3 border-t border-neutral-700">
                ...
                <div class="flex items-center gap-2 text-neutral-300">
                  <span class="inline-flex items-center gap-1 px-2 py-1 bg-success-600/20 text-success-600 text-body-sm font-semibold rounded">
                    <svg
                      class="w-3 h-3"
                      fill="none"
                      stroke="currentColor"
              ...
              <div class="pt-3 border-t border-neutral-700">
                <NuxtLink
                  to="/methodology"
                  class="inline-flex items-center gap-2 text-body-sm font-medium text-primary-400 hover:text-primary-300 transition-colors"
                >
          ...
          <div class="rounded-lg bg-surface border border-neutral-200 p-5">
          ...
          <div class="rounded-lg bg-gradient-to-br from-brand-600 to-brand-700 p-5 text-white">
            ...
            <NuxtLink
              to="/send-money"
              class="inline-flex items-center gap-2 w-full justify-center py-2.5 px-4 bg-surface text-brand-600 rounded-lg text-body-sm font-semibold hover:bg-brand-50 transition-colors"
            >
              Compare Rates
              <svg
                class="w-4 h-4"
...
defineOgImage({
  ...
  props: {
    title: computed(() => article.value?.title || 'Learn'),
    category: computed(() => article.value?.category || 'Learn'),
    readTime: computed(() => article.value?.readTime || '5 min read'),
  },
})

watchEffect(() => {
  const title = article.value?.title ? `${article.value.title} | Remit-Scout` : 'Learn | Remit-Scout'
  const description = article.value?.excerpt || 'Learn about international money transfers and best practices.'

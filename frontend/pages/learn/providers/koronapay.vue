    ...
    <section class="relative bg-gray-900 py-16 lg:py-24 overflow-hidden">
      <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative">
        <nav class="mb-8 flex items-center space-x-2 text-sm text-white/70 relative z-10">
          ...
          <span class="text-white/50">›</span>
          <span class="font-medium text-white">KoronaPay Review</span>
        </nav>
      ...
      <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
          ...
          <div class="text-center">
            ...
            <div class="text-sm text-slate-600">Card Transfers</div>
          </div>
          <div class="text-center">
            <div class="text-3xl font-bold text-slate-900">Cash Pickup</div>
            <div class="text-sm text-slate-600">Large Network</div>
          </div>
          <div class="text-center">
            <div class="text-3xl font-bold text-slate-900">EU/UK</div>
            <div class="text-sm text-slate-600">Primary Markets</div>
          </div>
        </div>
      </div>
    </section>
            ...
            <article class="max-w-none">
              ...
              <div class="not-prose my-8 rounded-2xl border-2 border-brand-200 bg-gradient-to-br from-brand-50 via-blue-50/50 to-brand-50 p-8 shadow-lg">
                ...
                <div class="grid sm:grid-cols-2 gap-4 mb-6">
                  <div class="p-4 rounded-xl bg-white/60 border border-brand-100">
                    ...
                    <div class="text-sm text-slate-700 leading-relaxed">Can price very competitively on some corridors with simple, low fees, but effective cost depends heavily on FX spread and corridor-specific conditions. Delivered value varies by corridor.</div>
                  </div>
                  <div class="p-4 rounded-xl bg-white/60 border border-brand-100">
                    <div class="flex items-center justify-between mb-2">
                    ...
                    <div class="text-sm text-slate-700 leading-relaxed">Corridor availability can be fluid with partner/bank interruptions. Reliability is partially partner- and corridor-dependent, which limits the upside.</div>
                  </div>
                  <div class="p-4 rounded-xl bg-white/60 border border-brand-100">
                    <div class="flex items-center justify-between mb-2">
                    ...
                    <div class="text-sm text-slate-700 leading-relaxed">Cash pickup can be available immediately after sending. Most card transfers are instant. Fast delivery options are a key strength.</div>
                  </div>
                  <div class="p-4 rounded-xl bg-white/60 border border-brand-100">
                    <div class="flex items-center justify-between mb-2">
                    ...
                    <div class="text-xs text-slate-500 mb-2">15% weight</div>
                    <div class="text-sm text-slate-700 leading-relaxed">24/7 call center support. Refund/cancellation friction: you can cancel only before payout, and transaction fees aren't refunded.</div>
                  </div>
                  <div class="sm:col-span-2 p-4 rounded-xl bg-white/60 border border-brand-100">
                    ...
                    <div class="text-sm text-slate-700 leading-relaxed">KoronaPay Europe Limited is an EMI regulated by the Central Bank of Cyprus (license 115.1.3.30). Licensed EU entity where applicable.</div>
                  </div>
                </div>
                <div class="mt-6 pt-6 border-t-2 border-brand-200 bg-white/40 rounded-xl p-4">
                  <div class="flex items-start gap-3">
                    ...
                    <div class="flex-1">
                      <div class="font-semibold text-slate-900 mb-2.5">Why 8.3 (not 9.0+):</div>
                      <div class="text-sm text-slate-700 leading-relaxed">Delivered Value is strong but inconsistent by corridor (spread and rate timing matter), while Reliability, Support, and Trust are solid in the EU-licensed context yet capped by the reality of a partner-based network and corridor volatility.</div>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="p-6 rounded-xl bg-gradient-to-br from-emerald-50 to-green-50 border-2 border-emerald-200">
                  ...
                  <ul class="space-y-3 text-slate-700">
                    <li class="flex items-start gap-2">
                      ...
                      <span>Cash pickup recipients who prefer collecting in-person rather than relying on bank deposits (KoronaPay advertises a large partner pickup network).</span>
                    </li>
                    <li class="flex items-start gap-2">
                      <svg class="w-5 h-5 text-emerald-600 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                      </svg>
                      <span>Fast card-to-card / cash-available transfers in corridors where KoronaPay is active and stable.</span>
                    </li>
                    <li class="flex items-start gap-2">
                      <svg class="w-5 h-5 text-emerald-600 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                      </svg>
                      <span>Senders in EU/UK/EEA/Norway/Switzerland routes where KoronaPay is supported and you can compare the total delivered amount inside the app before paying.</span>
                    </li>
                  </ul>
                </div>
                ...
                <div class="p-6 rounded-xl bg-gradient-to-br from-amber-50 to-orange-50 border-2 border-amber-200">
                  ...
                  <ul class="space-y-3 text-slate-700">
                    <li class="flex items-start gap-2">
                      ...
                      <span>"Set-and-forget cheapest" shoppers who don't want to monitor spreads by corridor—KoronaPay's value can vary depending on route and rate movement.</span>
                    </li>
                    <li class="flex items-start gap-2">
                      <svg class="w-5 h-5 text-amber-600 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12" />
                      </svg>
                      <span>Euro-to-euro transfers where you don't need cash pickup—KoronaPay charges 1.9% on EUR→EUR, which can be hard to justify versus other bank-like options.</span>
                    </li>
                    <li class="flex items-start gap-2">
                      <svg class="w-5 h-5 text-amber-600 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12" />
                      </svg>
                      <span>Users who want maximum regulatory simplicity / consistency across markets (KoronaPay's ecosystem involves multiple partners/entities depending on where the transfer runs).</span>
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div class="mb-20">
                ...
                <div class="p-6 rounded-xl bg-gradient-to-br from-amber-50 to-orange-50 border-2 border-amber-200 mb-6">
                  <p class="font-semibold text-slate-900 mb-3">One extra "gotcha" worth flagging:</p>
                ...
                <div class="p-6 rounded-xl border-2 border-emerald-200">
                  <p class="font-semibold text-slate-900 mb-3">"How often is KoronaPay the cheapest?"</p>
                  ...
                  <p class="text-slate-700 mb-3">What we can say in a data-first way:</p>
                  <ul class="space-y-2 text-slate-700">
                    <li class="flex items-start gap-2">
                      <svg class="w-5 h-5 text-emerald-600 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                      </svg>
                      <span>KoronaPay is most likely to win on effective cost when the corridor has (a) strong KoronaPay rails, and (b) competitors charging higher fixed fees or slower payout methods—but you still need to compare the actual delivered amount at checkout.</span>
                    </li>
                    <li class="flex items-start gap-2">
                      <svg class="w-5 h-5 text-amber-600 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
                      </svg>
                      <span>KoronaPay is less likely to win on simple EUR→EUR transfers because the 1.9% fee is structurally expensive for a same-currency flow.</span>
                    </li>
                  </ul>
                </div>
                ...
                <div class="mt-6 p-5 rounded-xl bg-gradient-to-br from-blue-50 to-slate-50 border-2 border-blue-200">
                  ...
                  <p class="text-slate-800 leading-relaxed mb-3">Where mismatches can happen:</p>
                  <ul class="space-y-2 text-slate-700">
              ...
              <div class="mb-20">
                ...
                <div class="space-y-4 text-lg leading-relaxed text-slate-700">
                  <div class="mt-5 p-5 rounded-xl bg-gradient-to-br from-emerald-50 to-green-50 border-2 border-emerald-200">
                    ...
                    <p class="text-slate-700 mb-3">Based on KoronaPay's own corridor pages and help documentation:</p>
                    <ul class="space-y-2 text-slate-700">
                  ...
                  <div class="mt-5 p-5 rounded-xl bg-gradient-to-br from-brand-50 to-blue-50 border-2 border-brand-200">
                    ...
                    <p class="text-slate-700 mb-3">KoronaPay commonly presents two main receiving rails:</p>
                    <ul class="space-y-2 text-slate-700">
              ...
              <div class="mb-20">
                ...
                <div class="space-y-4 text-lg leading-relaxed text-slate-700">
                  ...
                  <div class="mt-5 p-5 rounded-xl bg-gradient-to-br from-brand-50 to-blue-50 border-2 border-brand-200">
                    ...
                    <p class="text-slate-700 mb-3">KoronaPay's terms and help content are relatively clear:</p>
                    <ul class="space-y-2 text-slate-700">
              ...
              <div class="mb-22 p-6 rounded-xl bg-gradient-to-br from-brand-50 to-blue-50 border-2 border-brand-200">
                ...
                <ul class="space-y-3 text-slate-700">
                  <li class="flex items-start gap-2">
                    ...
                    <span>Always compare the delivered amount, not just the fee: cross-currency transfers have a fixed fee, so spread is usually the real cost driver.</span>
                  </li>
                  <li class="flex items-start gap-2">
                    <svg class="w-5 h-5 text-brand-600 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                    </svg>
                    <span>Check the rate right before paying—KoronaPay says rates change many times per day.</span>
                  </li>
                  <li class="flex items-start gap-2">
                    <svg class="w-5 h-5 text-brand-600 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                    </svg>
                    <span>Compare funding methods (card vs bank account). Bank-account funding may add bank-timed delay, while card funding is often the fastest.</span>
                  </li>
                  <li class="flex items-start gap-2">
                    <svg class="w-5 h-5 text-brand-600 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                    </svg>
                    <span>If delivering to a bank card, ask the recipient whether their bank/card charges incoming commissions (KoronaPay warns this can happen).</span>
                  </li>
                  <li class="flex items-start gap-2">
                    <svg class="w-5 h-5 text-brand-600 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                    </svg>
                    <span>Pick the payout method the recipient will actually use (cash pickup vs card). The "best" quote is wasted if the recipient can't access that rail conveniently.</span>
                  </li>
                  <li class="flex items-start gap-2">
                    <svg class="w-5 h-5 text-brand-600 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                    </svg>
                    <span>If you might need to cancel, remember: fees aren't refunded, and FX-converted refunds can be calculated at the refund-time rate.</span>
                  </li>
                </ul>
              </div>
              ...
              <div class="rounded-2xl border border-slate-200 bg-white p-6">
                ...
                <dl class="space-y-3 text-sm">
                  <div class="flex justify-between">
                    ...
                    <dd class="font-semibold text-slate-900">2003</dd>
                  </div>
                  <div class="flex justify-between">
                    <dt class="text-slate-600">Headquarters</dt>
                    <dd class="font-semibold text-slate-900">Cyprus</dd>
                  </div>
                  <div class="flex justify-between">
                  ...
                  <div class="flex justify-between">
                    ...
                    <dd class="font-semibold text-slate-900">Instant - 1 Hour</dd>
                  </div>
                  <div class="flex justify-between">
                    <dt class="text-slate-600">Payout Methods</dt>
                    <dd class="font-semibold text-slate-900">Cash, Card</dd>
                  </div>
                </dl>
              </div>
...
const breadcrumbItems = [
  ...
  { name: 'KoronaPay Review', path: '/learn/providers/koronapay' },
]

...
useHead({
  ...
  meta: [
    {
      name: 'description',
      content: 'Independent Xoom review with Remit-Score 8.5/10. Convenience + PayPal ecosystem, reliable, strong payout options. Detailed breakdown of fees, speed, and delivered value.',
    },
  ],
})

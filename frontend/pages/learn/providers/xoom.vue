    ...
    <section class="relative bg-gray-900 py-16 lg:py-24 overflow-hidden">
      <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative">
        <nav class="mb-8 flex items-center space-x-2 text-sm text-white/70 relative z-10">
          ...
          <span class="text-white/50">›</span>
          <span class="font-medium text-white">Xoom Review</span>
        </nav>
                ...
                <div class="relative inline-flex items-center justify-center">
                  <svg class="w-40 h-40 -rotate-90">
                    ...
                    <circle
                      ...
                      :stroke-dasharray="`${85 * 4.4} 440`"
                    />
                  </svg>
                  <div class="absolute inset-0 flex flex-col items-center justify-center">
                    <span class="text-5xl font-bold text-black">8.5</span>
      ...
      <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
          <div class="text-center">
            <div class="text-3xl font-bold text-slate-900">PayPal</div>
            <div class="text-sm text-slate-600">Ecosystem</div>
          </div>
          <div class="text-center">
            <div class="text-3xl font-bold text-emerald-600">Minutes</div>
            <div class="text-sm text-slate-600">Fast Delivery</div>
          </div>
          <div class="text-center">
          ...
          <div class="text-center">
            ...
            <div class="text-sm text-slate-600">Execution</div>
          </div>
        </div>
      </div>
    </section>
              ...
              <div class="not-prose my-8 rounded-2xl border-2 border-brand-200 bg-gradient-to-br from-brand-50 via-blue-50/50 to-brand-50 p-8 shadow-lg">
                ...
                <div class="grid sm:grid-cols-2 gap-4 mb-6">
                  <div class="p-4 rounded-xl bg-white/60 border border-brand-100">
                    ...
                    <div class="text-sm text-slate-700 leading-relaxed">Can be weaker due to fees/spread. Xoom charges transaction fees and earns via currency conversion. Often not the cheapest when comparing "recipient gets".</div>
                  </div>
                  <div class="p-4 rounded-xl bg-white/60 border border-brand-100">
                    <div class="flex items-center justify-between mb-2">
                    ...
                    <div class="text-sm text-slate-700 leading-relaxed">Clear delivery expectations. Funds delivered by date on receipt, often within minutes. Explicit about factors that can cause delays.</div>
                  </div>
                  <div class="p-4 rounded-xl bg-white/60 border border-brand-100">
                    <div class="flex items-center justify-between mb-2">
                    ...
                    <div class="text-sm text-slate-700 leading-relaxed">Multiple payout rails with fast "minutes" behavior in many cases. Strong payout options: bank, debit card, mobile wallet, cash pickup, home delivery.</div>
                  </div>
                  <div class="p-4 rounded-xl bg-white/60 border border-brand-100">
                    <div class="flex items-center justify-between mb-2">
                    ...
                    <div class="text-xs text-slate-500 mb-2">15% weight</div>
                    <div class="text-sm text-slate-700 leading-relaxed">Refund/cancellation is time-sensitive (30-minute window for full refund; after that, refunds are limited). Becomes hard once funds are picked up/deposited.</div>
                  </div>
                  <div class="sm:col-span-2 p-4 rounded-xl bg-white/60 border border-brand-100">
                    ...
                    <div class="text-sm text-slate-700 leading-relaxed">U.S. money transmission by PayPal, Inc. (NMLS ID). UK/EEA regulatory context published. Strong institutional trust signals via PayPal-linked licensing.</div>
                  </div>
                </div>
                <div class="mt-6 pt-6 border-t-2 border-brand-200 bg-white/40 rounded-xl p-4">
                  <div class="flex items-start gap-3">
                    ...
                    <div class="flex-1">
                      <div class="font-semibold text-slate-900 mb-1.5">Why 8.5 (not 9.0+):</div>
                      <div class="text-sm text-slate-700 leading-relaxed">Delivered Value (40%) is held back because Xoom discloses both transaction fees and that it earns money on currency conversion, which means effective cost can be higher than more rate-focused alternatives.</div>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="mb-6 p-5 rounded-xl bg-slate-50 border border-slate-200">
                  ...
                  <ul class="space-y-3 text-slate-700">
                    <li class="flex items-start gap-3">
                      ...
                      <span><strong class="text-slate-900">Transaction fees:</strong> it charges transaction fees (which vary by country, feature, limits, and other factors).</span>
                    </li>
                    <li class="flex items-start gap-3">
                      ...
                      <span><strong class="text-slate-900">FX spread / currency conversion margin:</strong> Xoom states that, in addition to transaction fees, it earns money when converting your send currency into a different currency.</span>
                    </li>
                  </ul>
                ...
                <div class="p-6 rounded-xl border-2 border-emerald-200">
                  ...
                  <ul class="space-y-2 text-slate-700">
                    <li class="flex items-start gap-2">
                      ...
                      <span>Xoom can be a rational choice when its payout convenience (cash pickup/home delivery/debit card deposit) saves time and hassle.</span>
                    </li>
                    <li class="flex items-start gap-2">
                      <svg class="w-5 h-5 text-amber-600 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
                      </svg>
                      <span>But if your top priority is lowest all-in price, Xoom is often not the first place you'd expect to win because it has both fees and spread in the mix.</span>
                    </li>
                  </ul>
                </div>
              ...
              <div class="mb-10">
                ...
                <div class="space-y-4 text-lg leading-relaxed text-slate-700">
                  ...
                  <div class="mt-5 p-5 rounded-xl bg-gradient-to-br from-brand-50 to-blue-50 border-2 border-brand-200">
                    ...
                    <p class="text-slate-700 mb-3">Two useful freshness cues Xoom provides:</p>
                    <ul class="space-y-2 text-slate-700">
                      <li>• A receipt-based delivery date promise ("delivered by the date listed on your receipt").</li>
                      <li>• A live "partner locations" locator (helpful for cash pickup) and corridor-specific pages with typical availability times.</li>
                    </ul>
                  </div>
              ...
              <div class="mb-10">
                ...
                <div class="space-y-4 text-lg leading-relaxed text-slate-700">
                  ...
                  <div class="mt-5 p-5 rounded-xl bg-gradient-to-br from-brand-50 to-blue-50 border-2 border-brand-200">
                    ...
                    <p class="text-slate-700 mb-3">Xoom's supported "receive" methods are a big reason it scores well on convenience:</p>
                    <ul class="space-y-2.5 text-slate-700">
                      <li class="flex items-start gap-2.5">
                        ...
                        <span>Bank account, debit card, mobile wallet</span>
                      </li>
                      <li class="flex items-start gap-2.5">
                        <svg class="w-5 h-5 text-brand-600 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                        </svg>
                        <span>Cash pickup or home delivery</span>
                      </li>
                      <li class="flex items-start gap-2.5">
                        <svg class="w-5 h-5 text-brand-600 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                        </svg>
                        <span>Pay international bills</span>
                      </li>
                      <li class="flex items-start gap-2.5">
                        <svg class="w-5 h-5 text-brand-600 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                        </svg>
                        <span>Reload prepaid mobile phones</span>
                      </li>
                    </ul>
                  </div>
                  <div class="mt-5 p-5 rounded-xl bg-gradient-to-br from-brand-50 to-blue-50 border-2 border-brand-200">
                    ...
                    <ul class="space-y-2 text-slate-700">
                      <li>• <strong class="text-slate-900">To the U.S.:</strong> debit card deposit and cash pickup are shown as typically available in minutes; bank deposit "within 2 days" on the U.S. flow page.</li>
                      <li>• <strong class="text-slate-900">To Mexico:</strong> Xoom's Mexico page describes cash pickup typically available in minutes, mobile wallet transfers typically completed in minutes, and bank deposit typically available within 1 hour during recipient bank processing hours.</li>
                    </ul>
                  </div>
                  <div class="mt-5 p-5 rounded-xl bg-slate-50 border-l-4 border-brand-600">
              ...
              <div class="mb-10">
                ...
                <div class="space-y-4 text-lg leading-relaxed text-slate-700">
                  <div class="mt-5 p-5 rounded-xl bg-gradient-to-br from-brand-50 to-blue-50 border-2 border-brand-200">
                    ...
                    <p class="text-slate-700 mb-3">Xoom's User Agreement says:</p>
                    <ul class="space-y-2.5 text-slate-700">
                      <li class="flex items-start gap-2.5">
                        <svg class="w-5 h-5 text-brand-600 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                        </svg>
                        <span>You can cancel for a full refund within 30 minutes of authorizing the transaction, unless funds/reload/bill pay have already been paid out.</span>
                      </li>
                      <li class="flex items-start gap-2.5">
                        <svg class="w-5 h-5 text-brand-600 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                        </svg>
                        <span>If eligible (funds not picked up or deposited), Xoom states it will refund your money within 4 business days of your cancellation request.</span>
                      </li>
                      <li class="flex items-start gap-2.5">
                        <svg class="w-5 h-5 text-amber-600 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
                        </svg>
                        <span>After 30 minutes, refunds are generally not provided except in limited circumstances.</span>
                      </li>
                      <li class="flex items-start gap-2.5">
                        <svg class="w-5 h-5 text-brand-600 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                        </svg>
                        <span>Refunds go back to the same payment method and are in the same send currency (not adjusted for currency value changes).</span>
                      </li>
                    </ul>
                    <p class="text-slate-700 mt-4 mb-0 text-sm">
                  ...
                  <div class="mt-5 p-5 rounded-xl bg-gradient-to-br from-amber-50 to-orange-50 border-2 border-amber-200">
                    ...
                    <ul class="space-y-2 text-slate-700">
                      <li>• Transactions may be delayed/cancelled for identity verification, fraud/AML review, or compliance with law.</li>
                      <li>• The faster the payout method (cash pickup / instant wallet), the smaller your real-world window to cancel.</li>
                    </ul>
                  </div>
                  <div class="mt-5 p-5 rounded-xl bg-slate-50 border-l-4 border-brand-600">
                  ...
                  <div class="mt-5 p-5 rounded-xl bg-gradient-to-br from-brand-50 to-blue-50 border-2 border-brand-200">
                    ...
                    <ul class="space-y-2.5 text-slate-700">
                      <li class="flex items-start gap-2.5">
                        ...
                        <span><strong class="text-slate-900">United States:</strong> Xoom's legal page states that all U.S. money transmission is provided by PayPal, Inc. (NMLS ID 910457) pursuant to PayPal's licenses, and links to state licensing disclosures.</span>
                      </li>
                      <li class="flex items-start gap-2.5">
                        <svg class="w-5 h-5 text-brand-600 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                        </svg>
                        <span><strong class="text-slate-900">UK/EEA:</strong> Xoom's legal page states PayPal (Europe) is licensed as a Luxembourg credit institution and under CSSF supervision, and references FCA temporary permissions regime context.</span>
                      </li>
                      <li class="flex items-start gap-2.5">
                        <svg class="w-5 h-5 text-brand-600 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                        </svg>
                        <span><strong class="text-slate-900">Australia:</strong> Xoom's fees page states the service is provided by PayPal Australia Pty Limited, which holds an Australian Financial Services Licence (AFSL).</span>
                      </li>
                    </ul>
                    <p class="text-slate-700 mt-4 mb-0 text-sm">
                ...
                <div class="p-6 rounded-xl bg-gradient-to-br from-emerald-50 to-green-50 border-2 border-emerald-200">
                  ...
                  <ul class="space-y-3 text-slate-700">
                    <li class="flex items-start gap-2.5">
                      ...
                      <span>People who value convenience (especially if you already live in the PayPal ecosystem) and want a familiar checkout experience.</span>
                    </li>
                    <li class="flex items-start gap-2.5">
                      <svg class="w-5 h-5 text-emerald-600 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                      </svg>
                      <span>Senders who need strong payout options (bank deposit, debit card deposit, mobile wallets, cash pickup/home delivery depending on corridor).</span>
                    </li>
                    <li class="flex items-start gap-2.5">
                      <svg class="w-5 h-5 text-emerald-600 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                      </svg>
                      <span>Transfers where reliability and predictable execution matter more than squeezing every last basis point of FX cost.</span>
                    </li>
                  </ul>
                </div>
                ...
                <div class="p-6 rounded-xl bg-gradient-to-br from-amber-50 to-orange-50 border-2 border-amber-200">
                  ...
                  <ul class="space-y-3 text-slate-700">
                    <li class="flex items-start gap-2.5">
                      ...
                      <span>Rate-maximizers who want the lowest all-in cost most of the time (Xoom charges transaction fees and also earns via currency conversion).</span>
                    </li>
                    <li class="flex items-start gap-2.5">
                      <svg class="w-5 h-5 text-amber-600 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12" />
                      </svg>
                      <span>Large transfers where FX spread can dominate total cost (because spread scales with amount, even when the fee looks small).</span>
                    </li>
                    <li class="flex items-start gap-2.5">
                      <svg class="w-5 h-5 text-amber-600 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12" />
                      </svg>
                      <span>Users outside Xoom's supported send/receive footprint for their corridor or payout type (availability and fees vary by country and feature).</span>
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div class="mb-10">
                ...
                <div class="space-y-6">
                  <div class="p-6 rounded-xl border-2 border-slate-200 bg-white hover:border-brand-300 transition-colors">
                    ...
                    <p class="text-slate-700 mb-0">
                      <strong class="text-slate-900">Choose Wise over Xoom when:</strong> You don't need cash pickup/home delivery, and you want to minimize hidden FX markup risk (spread).
                    </p>
                  </div>
                  ...
                  <div class="p-6 rounded-xl border-2 border-slate-200 bg-white hover:border-brand-300 transition-colors">
                    ...
                    <p class="text-slate-700 mb-0">
                      <strong class="text-slate-900">Choose Remitly over Xoom when:</strong> Your corridor is a core remittance route and you want providers built around those corridors, or you want to compare remittance-optimized delivery options and pricing in-app for your exact route.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div class="mb-10">
                ...
                <div class="space-y-5 text-lg leading-relaxed text-slate-700">
                  <div class="p-6 rounded-xl bg-gradient-to-br from-brand-50 to-blue-50 border-2 border-brand-200">
                    <p class="font-semibold text-slate-900 mb-3">Who should use Xoom?</p>
                    <p class="text-slate-800 mb-0">
                  ...
                  <div class="p-6 rounded-xl bg-gradient-to-br from-emerald-50 to-green-50 border-2 border-emerald-200">
                    <p class="font-semibold text-slate-900 mb-3">Why the 8.5/10 is justified:</p>
                    <p class="text-slate-800 mb-0">
            ...
            <div class="sticky top-40 space-y-6">
              ...
              <div class="rounded-2xl border-2 border-brand-200 bg-gradient-to-br from-brand-50 to-blue-50 p-6">
                ...
                <p class="text-sm text-slate-600 mb-4">
                  See how Xoom stacks up for your specific corridor and amount.
                </p>
                <NuxtLink
                  to="/send-money"
              ...
              <div class="rounded-2xl border border-slate-200 bg-white p-6">
                ...
                <dl class="space-y-3 text-sm">
                  <div class="flex justify-between">
                    ...
                    <dd class="font-semibold text-slate-900">PayPal</dd>
                  </div>
                  <div class="flex justify-between">
                  ...
                  <div class="flex justify-between">
                    <dt class="text-slate-600">Payout Options</dt>
                    <dd class="font-semibold text-slate-900">Multiple</dd>
                  </div>
                  <div class="flex justify-between">
                    <dt class="text-slate-600">Cancellation</dt>
                    <dd class="font-semibold text-slate-900">30 Min Window</dd>
                  </div>
                  <div class="flex justify-between">
                    <dt class="text-slate-600">Regulation</dt>
                    <dd class="font-semibold text-slate-900">PayPal Licensed</dd>
                  </div>
                </dl>
              </div>
    ...
    <section class="py-16 bg-blue-600" style="background-color: rgba(37, 99, 235, 1);">
      <div class="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center">
        <h2 class="text-3xl font-bold mb-4" style="color: rgba(255, 255, 255, 1);">
          Ready to See How Xoom Compares?
        </h2>
        <p class="text-lg mb-8" style="color: rgba(255, 255, 255, 1);">
          Enter your transfer details to see real-time rates from Xoom and 30+ other providers.
        </p>
        <NuxtLink
          to="/send-money"
...
setSeo({
  title: 'Xoom Review 2024 - Remit-Score 8.5/10 | Remit-Scout',
  description: 'Independent Xoom review with Remit-Score 8.5/10. Convenience + PayPal ecosystem, reliable, strong payout options. Detailed breakdown of fees, speed, and delivered value.',
  canonical: `${siteUrl}/learn/providers/xoom`,
  ogImage: `${siteUrl}/og-images/provider-xoom.jpg`,
})

const { addReviewSchema } = useStructuredData()
const reviewBody = `Xoom earns a Remit-Score of 8.5/10 based on our independent analysis. The provider offers convenience through the PayPal ecosystem with reliable execution and strong payout options. Detailed breakdown of fees, speed, and delivered value based on real transfer data.`

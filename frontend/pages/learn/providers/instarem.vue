        ...
        <div class="grid lg:grid-cols-3 gap-12">
          ...
          <div class="lg:col-span-2">
            <article class="max-w-none">
                ...
                <div class="grid sm:grid-cols-2 gap-4 mb-6">
                  <div class="p-4 rounded-xl bg-surface/60 border border-brand-100">
                    ...
                    <div class="text-body-sm text-neutral-700 leading-relaxed">
                      Strong in-core value potential, but you need to watch spread and especially card-related add-on fees. Cost can rise meaningfully with card funding.
                    </div>
                  </div>
                  <div class="p-4 rounded-xl bg-surface/60 border border-brand-100">
                    <div class="flex items-center justify-between mb-2">
                    ...
                    <div class="text-body-sm text-neutral-700 leading-relaxed">
                      Reliable where available, but breadth limits score ceiling. Supports sending from specific countries, which limits corridor breadth versus global generalists.
                    </div>
                  </div>
                  <div class="p-4 rounded-xl bg-surface/60 border border-brand-100">
                    <div class="flex items-center justify-between mb-2">
                    ...
                    <div class="text-body-sm text-neutral-700 leading-relaxed">
                      Most transfers arrive within 1–2 business days, and some corridors can be faster (including instant e-wallet payouts after funds are received, where available).
                    </div>
                  </div>
                  <div class="p-4 rounded-xl bg-surface/60 border border-brand-100">
                    <div class="flex items-center justify-between mb-2">
                    ...
                    <div class="text-body-sm text-neutral-700 leading-relaxed">
                      Refund timelines depend on funding method (24–72 business hours for bank-transfer refunds vs 5–7 business days for card refunds), and cancellations become harder once processing/conversion occurs.
                    </div>
                  </div>
                  <div class="sm:col-span-2 p-4 rounded-xl bg-surface/60 border border-brand-100">
                    ...
                    <div class="text-body-sm text-neutral-700 leading-relaxed">
                      Operated by Nium and publishes jurisdiction-by-jurisdiction licensing info; in Singapore, Nium is listed by MAS as a Major Payment Institution (license number published).
                    </div>
                  </div>
                </div>
                <div class="mt-6 pt-6 border-t-2 border-brand-200 bg-surface/40 rounded-xl p-4">
                  <div class="flex items-start gap-3">
                    ...
                    <div class="flex-1">
                      ...
                      <div class="text-body-sm text-neutral-700 leading-relaxed">
                        Delivered Value is solid in-core, but the score ceiling is limited by breadth (availability depends on where you're sending from and which payout types are supported), and card-funding fees can materially weaken delivered value if you're not careful.
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="p-6 rounded-xl bg-gradient-to-br from-success-600 to-success-50 border-2 border-success-600">
                  ...
                  <ul class="space-y-3 text-neutral-700">
                    <li class="flex items-start gap-2">
                      ...
                      <span><strong class="text-rs-fg">Delivered Value:</strong> Instarem publishes low headline pricing (e.g., personal sending "from 0.4%") and says fees/rates vary by amount, currency, payment method and receiving country/method—good transparency inputs for comparing "recipient gets."</span>
                    </li>
                    <li class="flex items-start gap-2">
                      <svg
                        class="w-5 h-5 text-success-600 mt-0.5 flex-shrink-0"
                      ...
                      <span><strong class="text-rs-fg">Friction & Speed:</strong> Instarem states most transfers arrive within 1–2 business days, and some corridors can be faster (including instant e-wallet payouts after funds are received, where available).</span>
                    </li>
                    <li class="flex items-start gap-2">
                      <svg
                        class="w-5 h-5 text-success-600 mt-0.5 flex-shrink-0"
                      ...
                      <span><strong class="text-rs-fg">Trust & Safety:</strong> Instarem is operated by Nium and publishes jurisdiction-by-jurisdiction licensing info; in Singapore, Nium is listed by MAS as a Major Payment Institution (license number published).</span>
                    </li>
                  </ul>
                </div>
                ...
                <div class="p-6 rounded-xl bg-gradient-to-br from-warning-600 to-warning-50 border-2 border-warning-200">
                  ...
                  <ul class="space-y-3 text-neutral-700">
                    <li class="flex items-start gap-2">
                      ...
                      <span><strong class="text-rs-fg">Delivered Value:</strong> Cost can rise meaningfully with card funding; Instarem's U.S. fees page says card payments may incur a 2%–3% payment method fee (plus possible issuer fees).</span>
                    </li>
                    <li class="flex items-start gap-2">
                      <svg
                        class="w-5 h-5 text-warning-800 mt-0.5 flex-shrink-0"
                      ...
                      <span><strong class="text-rs-fg">Reliability & Success:</strong> Availability is not universal—Instarem supports sending from specific countries (e.g., Australia, Canada, Singapore, Hong Kong, Malaysia, Euro Zone countries, UK, India, US), which limits corridor breadth versus global generalists.</span>
                    </li>
                    <li class="flex items-start gap-2">
                      <svg
                        class="w-5 h-5 text-warning-800 mt-0.5 flex-shrink-0"
                      ...
                      <span><strong class="text-rs-fg">Support & Refunds:</strong> Refund timelines depend on funding method (Instarem's FAQ says 24–72 business hours for bank-transfer refunds vs 5–7 business days for card refunds), and cancellations become harder once processing/conversion occurs.</span>
                    </li>
                  </ul>
                </div>
              </div>
                ...
                <div class="mb-6 p-5 rounded-xl bg-neutral-50 border border-rs-border">
                  ...
                  <ul class="space-y-3 text-neutral-700">
                    <li class="flex items-start gap-3">
                      ...
                      <span><strong class="text-rs-fg">Transaction fee:</strong> Instarem publishes that personal transfers are priced "from 0.4%" and explicitly notes that fees and exchange rates vary by sending amount, currency, payment method, and receiving country/method.</span>
                    </li>
                    <li class="flex items-start gap-3">
                      ...
                      <span><strong class="text-rs-fg">FX spread (rate markup):</strong> Instarem encourages comparing quoted rates to the mid‑market rate, and frames its rates as close to mid‑market (i.e., implying a small markup).</span>
                    </li>
                  </ul>
              ...
              <div class="mb-12 p-6 rounded-xl bg-gradient-to-br from-brand-50 to-primary-50 border-2 border-brand-200">
              ...
              <!-- Bottom line -->
              <div class="mb-12 p-8 rounded-2xl bg-gradient-to-br from-neutral-50 via-primary-50/30 to-neutral-50 border-2 border-rs-border">
                ...
                <p class="text-body-lg text-neutral-700 leading-relaxed mb-4">
                  <strong class="text-rs-fg">Who should use it:</strong> senders in Instarem's supported sending countries who want a straightforward bank-deposit (and sometimes e-wallet) transfer flow and are willing to compare funding methods to keep costs down.
                </p>
                <p class="text-body-lg text-neutral-700 leading-relaxed mb-0">
                  <strong class="text-rs-fg">Why the score is justified:</strong> Delivered Value is solid in-core, but the score ceiling is limited by breadth (availability depends on where you're sending from and which payout types are supported), and card-funding fees can materially weaken delivered value if you're not careful.
                </p>
              </div>
            </article>
          </div>
...
const providerName = 'Instarem'
const providerLogoUrl = `${siteUrl}${getProviderLogoPath('instarem')}`
...
setSeo({
  title: `Instarem Review ${new Date().getFullYear()} - Remit-Score 8.4/10 | Remit-Scout`,
  description: 'Independent Instarem review with Remit-Score 8.4/10. Fees, exchange rates, delivery speed, and key pros/cons to compare before you send.',

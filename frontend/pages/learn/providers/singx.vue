              ...
              <div class="mb-20">
                ...
                <div class="space-y-4 text-lg leading-relaxed text-slate-700">
                  ...
                  <div class="mt-5 p-5 rounded-xl bg-amber-50 border-2 border-amber-200">
                    ...
                    <p class="text-slate-700 mt-3 mb-0">
                      <strong class="text-slate-900">Practical implication:</strong> support is present and the processes are defined, but refund outcomes are not "free of friction"—fees and third-party costs can be deducted, and some cases can take time.
                    </p>
                  </div>
                </div>
              </div>

              ...
              <div class="mb-10">
                ...
                <div class="mb-6 p-5 rounded-xl bg-slate-50 border border-slate-200">
                  ...
                  <ul class="space-y-3 text-slate-700">
                    <li class="flex items-start gap-3">
                      ...
                      <span><strong class="text-slate-900">Fee you pay</strong> (varies by corridor/method), plus</span>
                    </li>
                    <li class="flex items-start gap-3">
                      ...
                      <span><strong class="text-slate-900">FX spread</strong> (difference between the mid‑market rate and the rate you're offered), plus</span>
                    </li>
                    <li class="flex items-start gap-3">
                      ...
                      <span><strong class="text-slate-900">Any external funding fees</strong> (like a credit card issuer charging a cash advance/processing fee — WorldRemit flags this risk directly)</span>
                    </li>
                  </ul>
                </div>
                ...
                <div class="p-6 rounded-xl bg-gradient-to-br from-blue-50 to-slate-50 border-2 border-blue-200 mb-6">
                  <p class="text-slate-800 leading-relaxed mb-4">
                    <strong class="text-slate-900">What to do (data-first):</strong> Compare providers by the same send amount + funding method + payout method and look at "receiver gets" at checkout. WorldRemit says you'll see fees upfront and the amount your receiver will get once you select receive method/partner.
                  </p>
                </div>
                ...
                <div class="space-y-4 text-lg leading-relaxed text-slate-700">
                  ...
                  <div class="mt-5 p-5 rounded-xl bg-gradient-to-br from-brand-50 to-blue-50 border-2 border-brand-200">
                    ...
                    <div class="flex flex-wrap gap-2">
                      ...
                      <span class="px-3 py-1 rounded-full bg-white border border-slate-200 text-sm text-slate-700">Airtime top‑up</span>
                      <span class="px-3 py-1 rounded-full bg-white border border-slate-200 text-sm text-slate-700">WorldRemit Wallet</span>
              ...
              <div class="mb-10">
                ...
                <div class="space-y-6">
                  <div class="p-6 rounded-xl border-2 border-slate-200 bg-white hover:border-brand-300 transition-colors">
                    ...
                    <p class="text-slate-700 mb-3">
                      <strong class="text-slate-900">When it can beat WorldRemit:</strong> Remitly tends to beat WorldRemit when you want stronger speed-tier clarity (especially "express" style options) and a consistently strong support reputation in common corridors (with the tradeoff that faster tiers can cost more).
                    </p>
                  </div>
                  ...
                  <div class="p-6 rounded-xl border-2 border-slate-200 bg-white hover:border-brand-300 transition-colors">
                    ...
                    <p class="text-slate-700 mb-3">
                      <strong class="text-slate-900">When it can beat WorldRemit:</strong> Sendwave tends to beat WorldRemit when you're in a supported corridor and your priority is very low friction and instant mobile money delivery. The tradeoff is corridor breadth—Sendwave's footprint is narrower.
                    </p>
                  </div>
                </div>
              </div>

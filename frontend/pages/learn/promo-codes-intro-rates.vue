      ...
      <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="prose prose-lg max-w-none">
          ...
          <div class="mb-12">
            ...
            <div class="rounded-3xl border-2 border-brand-200 bg-gradient-to-br from-brand-50 via-white to-blue-50 p-8 lg:p-12 shadow-xl mb-6">
          ...
          <div class="mb-12">
            ...
            <div class="grid md:grid-cols-3 gap-6">
              <div class="rounded-xl border-2 border-brand-200 bg-white p-6 shadow-sm">
                ...
                <div class="bg-brand-50 rounded-lg p-3 border border-brand-200 text-xs text-neutral-600">
...
setSeo({
  ...
  description: 'Learn how promotions work, why rankings change, and how to use promo codes wisely. Understand first-transfer promos, fee waivers, FX rate boosts, and limits.',

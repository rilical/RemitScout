      ...
      <div class="mx-auto max-w-page px-page-x">
        ...
        <div class="mt-12 max-w-4xl">
          ...
          <h1 class="text-hero font-bold tracking-tight text-white mb-6">
            <span class="text-brand-400">Hidden Fees</span> Explained:<br>
            <span class="text-brand-400">FX Markup vs Transfer Fee</span>
          </h1>
          <p class="text-h4 text-neutral-300 font-medium mb-6 leading-relaxed">
            Learn the difference between FX markup (spread) and upfront transfer fees, and why <span class="font-bold text-brand-400">"no fee" doesn't mean no cost</span>.
          </p>
      ...
      <div class="mx-auto max-w-page px-page-x">
        <div class="prose prose-lg max-w-none">
          ...
          <div class="mb-12">
            ...
            <div class="rounded-xl border-2 border-brand-200 bg-brand-50 p-6">
              ...
              <div class="bg-surface rounded-lg p-4 mb-3 border border-brand-200">
                <p class="text-body-sm font-medium text-brand-600 mb-1">
                  Markup Percentage
                </p>
                <p class="text-body-lg font-bold text-brand-600 font-mono">
          ...
          <div class="mb-12">
            ...
            <div class="rounded-3xl border-2 border-brand-200 bg-gradient-to-br from-brand-50 to-primary-50 p-8 lg:p-12">
              <p class="text-body text-neutral-700 leading-relaxed mb-6">
...
const breadcrumbItems = [
  ...
  { name: 'Hidden Fees', path: '/learn/hidden-exchange-rate-fees-explained' },
]

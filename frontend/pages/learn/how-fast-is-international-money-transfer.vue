...
setSeo({
  title: 'How Fast Is International Money Transfer? What Determines Delivery Time | Remit-Scout',
  description: 'Learn what determines transfer speed: payout methods, weekends, compliance holds, and payment methods. Speed buckets from instant to 5 days. Real-world examples and decision guide.',

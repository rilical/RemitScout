          ...
          <div class="grid gap-8 lg:grid-cols-3">
            <div class="relative">
              <div class="rounded-3xl bg-neutral-900 p-8 h-full flex flex-col outline-none shadow-none ring-0">
                <div class="flex items-center justify-center w-16 h-16 rounded-full bg-brand-600 mb-6 mx-auto">
                  <svg
                    class="w-8 h-8 text-white"
                    fill="none"
                    stroke="currentColor"
                ...
                <div class="text-center mb-4">
                  <span class="inline-flex items-center gap-2 px-4 py-1.5 bg-brand-600 text-white text-body-sm font-semibold rounded-full">
                    <span>2022</span>
                  </span>
                </div>
    ...
    <section class="py-16 lg:py-20 bg-surface">
      <div class="mx-auto max-w-page px-page-x">
        <div class="mx-auto max-w-5xl">
          ...
          <div class="mt-10 rounded-2xl border border-neutral-200 bg-neutral-50 p-6 sm:p-8 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
            <div>
              <p class="text-body font-semibold text-brand-600 uppercase tracking-wide mb-2">
                For enterprises and institutions
              </p>
              <p class="text-body-lg text-neutral-700 leading-relaxed max-w-2xl">
                Need corridor pricing data, proprietary cost indexes, or custom API access? We work with research teams, risk desks, and licensed MSBs under NDA.
              </p>
            </div>
            <NuxtLink
              to="/contact?type=enterprise&topic=data"
              class="flex-shrink-0 inline-flex items-center gap-2 px-7 py-3.5 bg-brand-600 hover:bg-brand-700 text-white font-semibold text-body rounded-xl motion-safe:transition-colors shadow-sm"
            >
              Get in touch
...
const whatWeDoCards = [
  {
    emoji: '💸',
    title: 'Transfer Comparison',
    body: 'Compare fees, FX markup, payout methods, and speed across providers.',
    to: '/send-money',
  },
  {
    emoji: '⭐️',

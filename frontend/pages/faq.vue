<template>
  <div class="min-h-screen bg-surface">
    ...
    <!-- Main Content -->
    <div class="mx-auto max-w-page px-page-x pb-0 pt-12">
      <div class="lg:grid lg:grid-cols-12 lg:gap-12">
        ...
        <div class="lg:col-span-9">
          ...
          >
            <h2 class="text-h2 font-bold text-brand-600 mb-8">
              Getting started
            </h2>
      ...
      <section class="py-12 sm:py-16 bg-brand-600 mt-20 w-screen relative left-1/2 right-1/2 -ml-[50vw] -mr-[50vw]">
        <div class="mx-auto max-w-page px-page-x">
...
const pricingFaqs = [
  ...
  },
  {
    ...
    answer: '<p><strong>Total cost</strong> includes everything that reduces what your recipient should receive:</p><ul class="list-disc pl-5 space-y-2 mt-3"><li><strong>Stated transfer fee:</strong> the upfront charge you see</li><li><strong>FX markup:</strong> the difference between a provider’s rate and a reference mid-market rate at the same time</li></ul><div class="bg-warning-50 border border-warning-200 rounded-lg p-4 my-4"><p class="text-body-sm font-semibold text-warning-800 mb-2">The hidden markup problem</p><p class="text-body-sm text-warning-700">Example: if the reference USD→MXN rate is 18.50 but a provider offers 18.00, that’s roughly a <strong>2.7% markup</strong>. On a $500 transfer, that’s meaningful — even before any stated fee.</p></div><p class="mt-2">Some providers advertise “$0 fees” but price through the exchange rate. Total cost helps you compare apples to apples.</p>',
  },
  {

...
/>
        ...
        <div class="mx-auto mt-8 max-w-4xl text-center">
          ...
          <p class="text-body-lg mx-auto mb-8 max-w-3xl text-neutral-300">
            Answers about how Remit‑Scout works: how we collect quotes, how we rank providers, how
            to read results, and what you get with Remit‑Scout Plus.
          </p>
      ...
      <div class="lg:grid lg:grid-cols-12 lg:gap-12">
        ...
        <aside class="hidden lg:col-span-3 lg:block">
          <div class="sticky top-24 space-y-2">
            <h3 class="text-body-sm mb-4 font-semibold uppercase tracking-wide text-neutral-500">
              Quick Navigation
            </h3>
            <nav class="space-y-1">
              <a
                ...
                :href="`#${category.id}`"
                :class="[
                  'text-body-sm block rounded-lg px-3 py-2 font-medium transition-colors',
...
>
      <div class="mx-auto max-w-4xl px-page-x text-center">
        ...
        <p class="text-body-lg mx-auto mb-10 max-w-2xl leading-relaxed text-white/80">
          If you can't find what you need here, contact us or report an issue — we read every
          message and use them to improve accuracy and clarity.
        </p>
        <div class="flex flex-wrap items-center justify-center gap-4">
          <NuxtLink
            to="/contact"
            class="text-body-lg inline-flex items-center gap-3 rounded-xl bg-brand-600 px-8 py-4 font-bold text-white duration-200 hover:bg-brand-700 hover:shadow-xl motion-safe:transition-all"
          >
            Contact support
          </NuxtLink>
          <NuxtLink
            to="/methodology"
            class="text-body-lg inline-flex items-center gap-3 rounded-xl border-2 border-white/30 px-8 py-4 font-bold text-white duration-200 hover:bg-white/10 motion-safe:transition-all"
          >
            Read Methodology
          </NuxtLink>
        </div>
...
const gettingStartedFaqs = [
  ...
  },
  {
    ...
    answer:
      '<p>Enter your send country, receive country, currency, amount, and (where available) payout method. We fetch quotes from multiple providers and standardize the results into comparable numbers, especially <strong>Recipient gets</strong>.</p><p class="mt-2">When you choose a provider, you click through to complete the transfer on that provider’s checkout.</p>',
  },
  {
...
const partnershipsFaqs = [
  {
    ...
    answer:
      '<p>Remit‑Scout may earn revenue in a few ways, with clear separation from rankings:</p><ul class="list-disc pl-5 space-y-1 mt-2"><li>Affiliate commissions when a user clicks a provider link and completes a transfer (where programs exist)</li><li>Remit‑Scout Plus subscriptions</li><li>Data licensing, static embeds, and managed widget integrations for publishers and platforms</li><li>Custom research and analysis for publishers or institutions</li></ul><p class="mt-2">Commercial relationships never override the ranking methodology. <a href="/partnerships" class="text-brand-600 hover:text-brand-700 underline font-semibold">Learn more about partnerships</a>.</p>',
  },
  {
    question: 'What does "We may earn a commission" mean?',
    answer:
      '<p>It means that if you click through to a provider and complete a qualifying action (like signing up or completing a transfer), the provider may pay us a referral commission. This does not change your cost with the provider, and it does not change how we rank providers.</p>',
  },
  {
    question: 'Do you sell rankings or "featured placements"?',
    answer:
      '<p>We do not sell ranking position. If we ever run sponsorships, they are labeled plainly as sponsorship and do not affect organic rankings, sorting, or Remit‑Score calculations.</p>',
  },
  {
...
const privacyFaqs = [
  {
    ...
    answer:
      '<p>Remit‑Scout does not send providers your personal identity details just because you compare. Providers may receive information if you click through and create an account or complete a transfer on their platform (which is necessary for the provider to process the transfer).</p>',
  },
  {
    question: 'Do you sell my personal data?',
    answer:
      '<p>No. We use data to operate and improve the product, not to sell personal profiles. If we use cookies or other tracking, we disclose it and provide choices where required.</p><p class="mt-2"><a href="/legal/privacy" class="text-brand-600 hover:text-brand-700 underline font-semibold">Read our privacy policy</a> for details.</p>',
  },
  {

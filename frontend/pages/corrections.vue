  ...
  >
    <div class="prose prose-lg max-w-none prose-headings:font-semibold prose-headings:text-rs-fg prose-a:font-semibold prose-a:text-brand-600">
      <p class="mb-6 text-body-lg leading-relaxed">
        This Corrections Policy explains how <strong class="text-brand-600">Remit-Scout</strong> handles accuracy issues,
      ...
      <div class="my-8 rounded-lg border-l-4 border-primary-500 bg-primary-50 p-6">
        ...
        <p class="text-primary-800 leading-relaxed">
          <strong class="text-brand-600">Remit-Scout</strong> is an independent comparison platform. We do not hold, move, or transmit money.
      ...
      <p class="mb-6 leading-relaxed">
        This policy applies to comparisons, provider pages, and editorial content across <strong class="text-brand-600">Remit-Scout</strong>.
      ...
      <p class="mb-4 leading-relaxed">
        <strong class="text-brand-600">Please include the following information:</strong>
      </p>
      <ul class="mb-6 list-inside list-disc space-y-2 leading-relaxed">
        <li><strong class="text-brand-600">Corridor:</strong> Sending country to receiving country</li>
        <li><strong class="text-brand-600">Send amount:</strong> Amount entered in the comparison</li>
        <li><strong class="text-brand-600">Payout method:</strong> Bank transfer, cash pickup, mobile wallet, etc.</li>
        <li><strong class="text-brand-600">Payment method:</strong> Bank transfer, debit card, credit card, etc.</li>
        <li><strong class="text-brand-600">Timestamp:</strong> When the quote was shown (date and approximate time)</li>
        <li><strong class="text-brand-600">Provider name:</strong> Provider being reported</li>
      ...
      <p class="mb-6 leading-relaxed">
        We aim to resolve confirmed issues within <strong class="text-brand-600">48 hours</strong>. Complex cases may take longer,
      ...
      <ul class="mb-6 list-inside list-disc space-y-2 leading-relaxed">
        <li><strong class="text-brand-600">Provider data feeds:</strong> Structured data shared by providers through APIs or partnerships</li>
        <li><strong class="text-brand-600">Public quote capture:</strong> Quotes captured from provider pricing flows and public interfaces</li>
        <li><strong class="text-brand-600">Spot-check transfers:</strong> Periodic real transfers on select corridors to verify accuracy</li>
      </ul>
      <p class="mb-6 leading-relaxed">
      ...
      <p class="mb-4 leading-relaxed">
        <strong class="text-brand-600">Review guidelines:</strong>
      </p>
      <ul class="mb-6 list-inside list-disc space-y-2 leading-relaxed">
        <li><strong class="text-brand-600">Be truthful:</strong> Reviews should reflect a genuine experience with the provider</li>
        <li><strong class="text-brand-600">No personal data:</strong> Do not share account numbers, transfer IDs, or sensitive information</li>
        <li><strong class="text-brand-600">No abuse:</strong> Harassment or hateful content is removed immediately</li>
        <li><strong class="text-brand-600">No spam:</strong> Promotional content or affiliate links are not allowed</li>
        <li><strong class="text-brand-600">Stay relevant:</strong> Keep feedback focused on the provider and transfer experience</li>
      </ul>
      <p class="mb-6 leading-relaxed">
...
defineOgImage({
  ...
  props: {
    title: 'Corrections Policy',
    description: 'How Remit-Scout handles corrections, verifies data, and resolves accuracy issues so users can trust comparisons and provider scores.',
  },
})

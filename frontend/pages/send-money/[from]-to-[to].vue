      ...
      <div class="container py-8">
        ...
        <template v-else>
          ...
          >
            ...
            <p v-if="supportedMethods.length" class="mt-2 text-neutral-600">
          ...
          >
            <template v-for="(row, index) in enrichedProviders" :key="row.provider">
              <div
                  ...
                  <div class="flex items-center gap-4">
                    ...
                    <div class="flex-1">
                      ...
                      <div class="flex items-center gap-3">
                        ...
                        <p v-if="row.isStale" class="text-body-sm font-medium text-warning-100">

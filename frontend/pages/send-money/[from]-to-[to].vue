...
const showMonetizedAds = computed(() => !isPlus.value && adsEnabled.value && marketingConsent.value)
...
async function handleNewQuery(data: {
  ...
  const resolvedFromCountry = resolveCountryCodeFromInput('corridor-from-country', data.fromCountry)

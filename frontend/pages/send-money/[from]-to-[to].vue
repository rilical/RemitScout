  ...
  <div class="min-h-screen bg-neutral-50">
    ...
    <section class="bg-neutral-900 text-white relative overflow-hidden">
      <div class="container relative py-8">
        <!-- Breadcrumb -->
        <nav aria-label="Breadcrumb" class="mb-6 text-body-sm">
          <ol class="flex flex-wrap items-center gap-2">
            ...
            <li class="text-neutral-600" aria-hidden="true">
              <svg
                class="w-4 h-4"
                fill="none"
                stroke="currentColor"
          ...
          <div class="bg-surface rounded-2xl shadow-2xl shadow-black/20 overflow-hidden">
            ...
            <div class="p-5">
              ...
              <div
                ...
                class="mt-3 flex items-center justify-center gap-2 text-body-sm text-white bg-success-600 rounded-lg py-2 px-3"
              >
                <svg
                  class="w-4 h-4"
                  fill="none"
      ...
      <div class="container py-8">
        ...
        <template v-else>
          ...
          <div
            ...
            class="rounded-xl border-2 border-danger-600 bg-danger-600/10 p-4 text-body-sm text-danger-600"
          >
          ...
          <div
            ...
            class="rounded-xl border-2 border-warning-600 bg-warning-50 p-4 text-body-sm text-warning-700"
          >
                      ...
                      <div class="text-body-sm">
                        <span
                          :class="[
                            ...
                            row._rateComparison.isBetter
                              ? 'text-success-600'
                              : row._rateComparison.isWorse
                                ? 'text-danger-600'
                                : 'text-neutral-700',
                          ]"
                        >
